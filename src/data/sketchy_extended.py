...
def Sketchy_Extended(args, transform='None'):
    ...
    # Data Loaders
    train_loader = Sketchy_Extended_train(args, train_class, dicts_class, class_emb, vocab, transform)
    valid_sk_loader = Sketchy_Extended_valid_test(args, valid_class, dicts_class, class_emb, vocab, transform, type_skim='sketch')
